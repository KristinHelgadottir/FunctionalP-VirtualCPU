...
public class Machine {
    ...
    public void tick() {
        ...
        } else if (instr == 0b0000_0010) { // MUL A B
            cpu.setA(cpu.getA() * cpu.getB());
            cpu.setIp(cpu.getIp() + 1);
        } else if (instr == 0b0000_0011) { // DIV A B
            cpu.setA(cpu.getA() / cpu.getB());
            cpu.setIp(cpu.getIp() + 1);
        } else if (instr == 0b0000_0100) { // ZERO |	F ← A = 0; IP++
        ...
        { //HALT  |	Halts execution
        } else if ((instr & 0b1111_1110) == 0b0001_0000) {  // PUSH r  |  [--SP] ← r; IP++
            ...
            cpu.incIp();
        } else if ((instr & 0b1111_1110) == 0b0001_0010) { // POP r  |  r ← [SP++]; IP++
            int r = instr & 0b0000_0001;
            ...
            cpu.incIp();
        } else if (instr == 0b0001_0100) { // Mov A B |  B ← A; IP++
            cpu.setB(cpu.getA());
            cpu.incIp();
        } else if (instr == 0b0001_0101) { // Mov B A  |  A ← B; IP++
            cpu.setA(cpu.getB());
            cpu.incIp();
        ...
        }else if(instr == 0b0001_0110) // INC
        {
        ...
        else if ((instr & 0b1111_0000) == 0b0010_0000) { // MOV r o  |  [SP + o] ← r; IP++  
            ...
            cpu.incIp();
        } else if ((instr & 0b1111_0000) == 0b0011_0000) {// MOV  o r | r ← [SP + o]; IP++
            ...
            cpu.incIp();
        } else if ((instr & 0b1100_0000) == 0b0100_0000) { // MOV v r |  r ← v; IP++
            ...
            cpu.incIp();
        } else if ((instr & 0b1100_0000) == 0b1100_0000) {// CALL 11AAAAAA
        ...
        } else if ((instr & 0b1000_0000) == 0b1000_0000) { // JMP #a
            int a = (instr & 0b0011_1111);
